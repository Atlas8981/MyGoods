...
public class RecentViewCollectionView extends RecyclerView.Adapter<RecentViewCollectionView.ViewHolder> {

    private ArrayList<Item> data = new ArrayList<Item>();
    private RecentViewOnItemClick recentViewOnItemClick;
    private Context mContext;

    public RecentViewCollectionView(Context mContext, ArrayList<Item> data, RecentViewOnItemClick recentViewOnItemClick) {
        this.mContext = mContext;
        this.recentViewOnItemClick = recentViewOnItemClick;
        this.data = data;
    }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    recentViewOnItemClick.onRecentViewItemClickListener(getAdapterPosition());
                }
            });
        }
    }

    public interface RecentViewOnItemClick {
        void onRecentViewItemClickListener(int pos);
    }
}

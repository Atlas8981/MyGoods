package com.example.mygoods.Listeners;
...
public class SwipeDownTouchListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link SwipeDownTouchListener} to inform its client
     ...
     *                 dismiss this view.
     */
    public SwipeDownTouchListener(View view, Object token, DismissCallbacks callbacks) {
